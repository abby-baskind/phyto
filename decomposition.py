class decomposition():
    def decomposition(df, timeslice, location = None):
        ...
        # umolC/kg/month
        MN['DIC_flux [umolC/kg]'] = -(fgco2_month/MLD)*(1e6)/rho
        # finite difference
        MN['∆DIC_flux [umolC/kg]'] = MN['DIC_flux [umolC/kg]'].diff()
        # -------------------------------------------------------------------------------------------------
    ...
    def ASF(df, timeslice, location = None):
        ...
        # Calculate components-----------------------------------------------------------------------------
        temp =  MN['∆T']                          # Temperature: ∂H/∂T * ∆T
        sal =   MN['∆S']                           # salinity: ∂H/∂S * ∆S
        alk_mix = MN['∆TA_mix [umolC/kg]']       # TA mixing: ∂H/∂TA * ∆TAmix
        alk_bio =  MN['∆TA_bio [umolC/kg]']       # TA bio: ∂H/∂TA * ∆TAbio
        dic_bio = MN['∆DIC_bio [umolC/kg]']     # DIC bio: ∂H/∂DIC * ∆DICbio
        ASF =  MN['DIC_flux [umolC/kg]']        # DIC air sea flux: ∂H/∂DIC * ∆DICflux
        dic_mix =  MN['∆DIC_mix']               # DIC mixing: ∂H/∂DIC * ∆DICmix
        BIO = dic_bio + alk_bio                                # Total bio = DIC bio + TA bio
        MIX = dic_mix + alk_mix                                # Total mixing = DIC mixing + TA mixing
        TOT = temp + sal + ASF + BIO + MIX                     # Total
